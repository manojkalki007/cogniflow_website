...
const TTS_VOICES = {
  female: [
    { id: "jessica", label: "Jessica", desc: "Clear & warm, American", provider: "smallest", accent: "american" },
    { id: "sophia", label: "Sophia", desc: "Professional American", provider: "smallest", accent: "american" },
    { id: "natasha", label: "Natasha", desc: "Confident & bold", provider: "smallest", accent: "american" },
    { id: "rachel", label: "Rachel", desc: "Friendly & approachable", provider: "smallest", accent: "american" },
    { id: "olivia", label: "Olivia", desc: "Warm & natural American", provider: "smallest", accent: "american" },
    { id: "isla", label: "Isla", desc: "Elegant British", provider: "smallest", accent: "british" },
    { id: "chloe", label: "Chloe", desc: "Bright Australian", provider: "smallest", accent: "australian" },
    { id: "maya", label: "Maya", desc: "Warm Indian English", provider: "smallest", accent: "indian" },
    { id: "meera", label: "Meera", desc: "Natural Hindi", provider: "smallest", accent: "indian" },
  ...
  male: [
    ...
    { id: "daniel", label: "Daniel", desc: "Clear & warm American", provider: "smallest", accent: "american" },
    { id: "ryan", label: "Ryan", desc: "Casual American", provider: "smallest", accent: "american" },
    { id: "lucas", label: "Lucas", desc: "Professional American", provider: "smallest", accent: "american" },
    { id: "jordan", label: "Jordan", desc: "Confident American", provider: "smallest", accent: "american" },
    { id: "liam", label: "Liam", desc: "Professional British", provider: "smallest", accent: "british" },
    { id: "noah", label: "Noah", desc: "Trustworthy British", provider: "smallest", accent: "british" },
    { id: "arjun", label: "Arjun", desc: "Confident Indian English", provider: "smallest", accent: "indian" },
    { id: "vikram", label: "Vikram", desc: "Authoritative Hindi", provider: "smallest", accent: "indian" },
  ...
  useEffect(() => {
    if (agentData && !agentData.error) {
      const populated = {
        ...
        voice_id: agentData.voice_id || "jessica",
